...
NextStarsRow
	NEXTREG _MMU_REG_SLOT6_H56, db.STARTS_SB44	; Assign bank 44 to slot 6 (see di_data_bin.asm)
	NEXTREG _MMU_REG_SLOT7_H57, db.STARTS_EB45	; Assign bank 45 to slot 7
