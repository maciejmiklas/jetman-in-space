...
SYNC_TOP_D0             = 0
SYNC_BOTTOM_D255        = 255                   ; Sync to scanline 192, scanline on the frame (256 > Y > 192) might be skipped on 60Hz.
...
SetClipTop50
    ...
    ; Clip Window layer 2
    NEXTREG _DC_REG_CLIP_L2_H18, _CLIP_FULL_X1_D0
    NEXTREG _DC_REG_CLIP_L2_H18, _CLIP_FULL_X2_D159
    NEXTREG _DC_REG_CLIP_L2_H18, CLIP_TOP50_D50
    NEXTREG _DC_REG_CLIP_L2_H18, _CLIP_FULL_FULLY2_D255
...
ResetClippings
    ...
    NEXTREG _DC_REG_CLIP_L2_H18, _CLIP_FULL_X1_D0
    NEXTREG _DC_REG_CLIP_L2_H18, _CLIP_FULL_X2_D159
    NEXTREG _DC_REG_CLIP_L2_H18, _CLIP_FULL_Y1_D0
    NEXTREG _DC_REG_CLIP_L2_H18, _CLIP_FULL_FULLY2_D255
...
WaitForBottomScanline
    ...
    _WaitForScanline SYNC_BOTTOM_D255
