...
fEnemyL10
    FES {STATE_DEPLOY_RIGHT ,     040/*RESPAWN_Y*/, 15/*RESPAWN_DELAY*/, 00/*MOVE_DELAY*/}
    FES {STATE_DEPLOY_LEFT  ,     040/*RESPAWN_Y*/, 25/*RESPAWN_DELAY*/, 01/*MOVE_DELAY*/}
    FES {STATE_DEPLOY_RIGHT ,     080/*RESPAWN_Y*/, 15/*RESPAWN_DELAY*/, 00/*MOVE_DELAY*/}
    ...
    FES {STATE_DEPLOY_LEFT  ,     128/*RESPAWN_Y*/, 20/*RESPAWN_DELAY*/, 01/*MOVE_DELAY*/}
    FES {STATE_DEPLOY_LEFT  ,     216/*RESPAWN_Y*/, 23/*RESPAWN_DELAY*/, 00/*MOVE_DELAY*/}
    FES {STATE_DEPLOY_RIGHT ,     216/*RESPAWN_Y*/, 18/*RESPAWN_DELAY*/, 01/*MOVE_DELAY*/}
    FES {STATE_DEPLOY_LEFT  ,     232/*RESPAWN_Y*/, 25/*RESPAWN_DELAY*/, 03/*MOVE_DELAY*/}
