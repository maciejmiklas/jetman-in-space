...
fEnemyL08
    ...
    FES {STATE_DEPLOY_LEFT  /*STATE*/, 040/*RESPAWN_Y*/, 15/*RESPAWN_DELAY*/, 01/*MOVE_DELAY*/}
    FES {STATE_DEPLOY_RIGHT /*STATE*/, 080/*RESPAWN_Y*/, 05/*RESPAWN_DELAY*/, 00/*MOVE_DELAY*/}
    FES {STATE_DEPLOY_LEFT  /*STATE*/, 080/*RESPAWN_Y*/, 10/*RESPAWN_DELAY*/, 02/*MOVE_DELAY*/}
    ...
    FES {STATE_DEPLOY_RIGHT /*STATE*/, 180/*RESPAWN_Y*/, 15/*RESPAWN_DELAY*/, 01/*MOVE_DELAY*/}
