...
; Level 6
fEnemyL06
    FES {STATE_DEPLOY_LEFT  ,     070/*RESPAWN_Y*/, 11/*RESPAWN_DELAY*/, 00/*MOVE_DELAY*/}
    FES {STATE_DEPLOY_LEFT  ,     040/*RESPAWN_Y*/, 15/*RESPAWN_DELAY*/, 01/*MOVE_DELAY*/}
    FES {STATE_DEPLOY_RIGHT ,     020/*RESPAWN_Y*/, 11/*RESPAWN_DELAY*/, 00/*MOVE_DELAY*/}
    FES {STATE_DEPLOY_LEFT  ,     125/*RESPAWN_Y*/, 15/*RESPAWN_DELAY*/, 00/*MOVE_DELAY*/}
    FES {STATE_DEPLOY_RIGHT ,     224/*RESPAWN_Y*/, 15/*RESPAWN_DELAY*/, 00/*MOVE_DELAY*/}
    FES {STATE_DEPLOY_LEFT  ,     140/*RESPAWN_Y*/, 05/*RESPAWN_DELAY*/, 01/*MOVE_DELAY*/}
FENEMY_SIZE_L6          = 6
