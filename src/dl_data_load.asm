...
; Sprites for Level 1 are stored in Bank 40, 41 (DI_BANK40_SPR1/2_41)
	NEXTREG _MMU_REG_SLOT_6_H56, DI_BANK40_SPR1		; Assign bank 40 to slot 6
	NEXTREG _MMU_REG_SLOT_7_H57, DI_BANK41_SPR2		; Assign bank 41 to slot 7
...
;----------------------------------------------------------;
	NEXTREG _MMU_REG_SLOT_6_H56, DI_BANK42_PALETTE	; Assign bank 42 to slot 6
	CALL TiLoadTiles	