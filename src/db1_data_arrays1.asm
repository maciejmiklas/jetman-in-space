...
tilePaletteBinLength1 = $ - tilePaletteBin1     ; Length can have max 255 bytes!
...
tilePaletteBinLength2 = $ - tilePaletteBin2     ; Length can have max 255 bytes!
