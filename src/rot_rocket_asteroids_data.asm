...
; See rot.randMovAddr
randMov1                DB 0,1,  0,1|$80, 3,1,  3,1|$80,  5,1,  5,1|$80,  2,1,  2,1|$80,  6,1,  6,1|$80, 5,1,  5,1|$80,  0,1
                        DB 2,2,  4,1,  6,2,  6,1|$80,  0,1,  1,2,  4,1,  6,1,  5,1,  2,1|$80,  3,2,  5,1|$80,  2,1,  5,2,  6,1|$80
                        DB 3,1|$80,  4,2|$80
...
;        X    Y    MOVE_SPD MOVE_PAT ACTIVE
    ASD {300, 020, 1,       MP2,     AS_ACTIVE_NO} ; 0
    ASD {010, 000, 2,       MP1,     AS_ACTIVE_NO} ; 1
    ASD {300, 050, 1,       MP2,     AS_ACTIVE_NO} ; 2
    ASD {300, 120, 2,       MP2,     AS_ACTIVE_NO} ; 3
    ASD {150, 000, 1,       MP1,     AS_ACTIVE_NO} ; 4
    ASD {200, 000, 2,       MP1,     AS_ACTIVE_NO} ; 5
    ASD {300, 200, 1,       MP2,     AS_ACTIVE_NO} ; 6

randMov3                 DB 0,2,  3,2,  5,2,  0,2|$80,  3,2|$80,  5,2|$80,  1,1,  2,1,  4,1,  1,1|$80,  2,1|$80,  4,1|$80 
                        DB 0,5|$80,  1,5|$80,  2,5|$80,  3,5|$80,  4,5|$80,  5,5|$80,  6,5|$80
                        DB 0,1, 1,1, 2,1, 3,1, 4,1, 5,1, 6,1, 0,1, 3,1, 5,1

; See rot.randMovAddr
asDeploy4
;        X    Y    MOVE_SPD MOVE_PAT ACTIVE
    ASD {300, 020, 2,       MP2,     AS_ACTIVE_NO} ; 0
    ASD {010, 000, 3,       MP1,     AS_ACTIVE_NO} ; 1
    ASD {300, 050, 1,       MP2,     AS_ACTIVE_NO} ; 2
    ASD {300, 120, 3,       MP2,     AS_ACTIVE_NO} ; 3
    ASD {150, 000, 2,       MP1,     AS_ACTIVE_NO} ; 4
    ASD {200, 000, 1,       MP1,     AS_ACTIVE_NO} ; 5
    ASD {300, 200, 4,       MP2,     AS_ACTIVE_NO} ; 6


randMov4                DB 0,2,  3,2,  5,2,  0,2|$80,  3,2|$80,  5,2|$80,  1,1,  2,1,  4,1,  1,1|$80,  2,1|$80,  4,1|$80 
                        DB 0,5|$80,  1,5|$80,  2,5|$80,  3,5|$80,  4,5|$80,  5,5|$80,  6,5|$80
