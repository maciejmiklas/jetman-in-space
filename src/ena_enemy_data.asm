...
singleEnemiesL1
    ...
    ENPS {020,        015,          movePattern01D3,   sp.SDB_ENEMY1 enp.ENP_LEFT_HIT  }
    ENPS {040,        025,          movePattern01D2,   sp.SDB_ENEMY1 enp.ENP_RIGHT_HIT }
    ENPS {050,        030,          movePattern01D2,   sp.SDB_ENEMY1 enp.ENP_LEFT_HIT  }
    ...
    ENPS {150,        034,          movePattern01D3,   sp.SDB_ENEMY1 enp.ENP_RIGHT_HIT }
