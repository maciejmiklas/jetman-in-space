...
; sinus, up
movePattern20
    DB 65, %0'010'1'001,$22, %0'011'1'010,$22, %0'100'1'011,$21, %0'011'1'011,$21, %0'010'1'011,$23, %0'001'1'011,$22, %0'001'1'100,$22, %0'001'1'101,$21   ; going up, above X
        DB %1'001'1'101,$11, %1'001'1'100,$12, %1'001'1'011,$12, %1'010'1'011,$13, %1'011'1'011,$11, %1'100'1'011,$11, %1'011'1'010,$12, %1'010'1'001,$12   ; going down, above X
        DB %1'010'1'001,$11, %1'011'1'010,$11, %1'100'1'011,$11, %1'011'1'011,$11, %1'010'1'011,$13, %1'001'1'011,$12, %1'001'1'100,$12, %1'001'1'101,$11   ; going down, below X
        DB %0'001'1'101,$11, %0'001'1'100,$12, %0'001'1'011,$12, %0'010'1'011,$13, %0'011'1'011,$11, %0'100'1'011,$21, %0'011'1'010,$32, %0'010'1'001,$32   ; going up, below X
        DB %1'111'1'111,$2F 
...
singleEnemiesL1
    ...
    ENPS {020,        015,          movePattern01D1,   sp.SDB_ENEMY1 enp.ENP_LEFT_HIT  }
    ENPS {040,        025,          movePattern01D2,   sp.SDB_ENEMY1 enp.ENP_RIGHT_HIT }
    ENPS {060,        020,          movePattern01D2,   sp.SDB_ENEMY1 enp.ENP_LEFT_HIT  }
    ENPS {085,        025,          movePattern01D2,   sp.SDB_ENEMY1 enp.ENP_LEFT_HIT  }
    ENPS {090,        030,          movePattern01D3,   sp.SDB_ENEMY1 enp.ENP_RIGHT_HIT }
    ENPS {105,        020,          movePattern01D2,   sp.SDB_ENEMY1 enp.ENP_LEFT_HIT  }
    ENPS {125,        025,          movePattern01D1,   sp.SDB_ENEMY1 enp.ENP_RIGHT_HIT }
    ENPS {150,        024,          movePattern01D3,   sp.SDB_ENEMY1 enp.ENP_LEFT_HIT  }
    ENPS {160,        024,          movePattern01D1,   sp.SDB_ENEMY1 enp.ENP_RIGHT_HIT }
    ENPS {175,        010,          movePattern01D2,   sp.SDB_ENEMY1 enp.ENP_LEFT_HIT  }
    ENPS {190,        012,          movePattern01D1,   sp.SDB_ENEMY1 enp.ENP_RIGHT_HIT }
    ENPS {220,        020,          movePattern01D3,   sp.SDB_ENEMY1 enp.ENP_LEFT_HIT  }
    ENPS {230,        010,          movePattern01D2,   sp.SDB_ENEMY1 enp.ENP_RIGHT_HIT }
SINGLE_ENEMIES_L1       = 13

; ##############################################
; Level 2
singleEnemiesL2
    ;     RESPAWN_Y   RESPAWN_DELAY MOVE_PAT_ADDR      SDB_INIT      SETUP
    ENPS {020,        005,          movePattern01D1,   sp.SDB_ENEMY1 enp.ENP_LEFT_ALONG    }
    ENPS {020,        010,          movePattern01D2,   sp.SDB_ENEMY1 enp.ENP_RIGHT_HIT     }
    ENPS {040,        005,          movePattern01D1,   sp.SDB_ENEMY1 enp.ENP_RIGHT_ALONG   }
    ENPS {080,        008,          movePattern02D2,   sp.SDB_ENEMY1 enp.ENP_LEFT_HIT      }
    ...
    ENPS {140,        011,          movePattern02D2,   sp.SDB_ENEMY1 enp.ENP_LEFT_HIT      }
    ENPS {180,        010,          movePattern01D3,   sp.SDB_ENEMY1 enp.ENP_RIGHT_ALONG   }
    ENPS {200,        011,          movePattern16,     sp.SDB_ENEMY2 enp.ENP_RIGHT_ALONG   }
    ENPS {220,        007,          movePattern01D1,   sp.SDB_ENEMY1 enp.ENP_LEFT_ALONG    }
    ENPS {220,        010,          movePattern01D2,   sp.SDB_ENEMY1 enp.ENP_RIGHT_ALONG   }
...
singleEnemiesL3
    ;     RESPAWN_Y   RESPAWN_DELAY MOVE_PAT_ADDR      SDB_INIT      SETUP
    ENPS {010,        015,          movePattern01D3,   sp.SDB_ENEMY1 enp.ENP_LEFT_ALONG}
    ...
    ENPS {060,        015,          movePattern02D0,   sp.SDB_ENEMY1 enp.ENP_LEFT_HIT  }
    ENPS {060,        012,          movePattern02D2,   sp.SDB_ENEMY1 enp.ENP_RIGHT_HIT }
    ENPS {080,        021,          movePattern02D3,   sp.SDB_ENEMY2 enp.ENP_LEFT_HIT  }
    ENPS {080,        011,          movePattern02D2,   sp.SDB_ENEMY2 enp.ENP_RIGHT_HIT }
    ENPS {100,        018,          movePattern02D1,   sp.SDB_ENEMY2 enp.ENP_LEFT_HIT  }
    ENPS {100,        013,          movePattern02D2,   sp.SDB_ENEMY2 enp.ENP_RIGHT_HIT }
    ENPS {120,        017,          movePattern02D1,   sp.SDB_ENEMY2 enp.ENP_LEFT_HIT  }
    ENPS {120,        018,          movePattern02D3,   sp.SDB_ENEMY2 enp.ENP_RIGHT_HIT }
    ENPS {140,        013,          movePattern02D2,   sp.SDB_ENEMY2 enp.ENP_LEFT_HIT  }
    ENPS {140,        023,          movePattern02D1,   sp.SDB_ENEMY2 enp.ENP_RIGHT_HIT }
    ENPS {160,        018,          movePattern02D1,   sp.SDB_ENEMY1 enp.ENP_LEFT_HIT  }
    ENPS {160,        017,          movePattern02D2,   sp.SDB_ENEMY1 enp.ENP_RIGHT_HIT }
    ENPS {180,        025,          movePattern02D1,   sp.SDB_ENEMY1 enp.ENP_LEFT_HIT  }
    ENPS {180,        015,          movePattern02D2,   sp.SDB_ENEMY1 enp.ENP_RIGHT_HIT }
    ENPS {200,        018,          movePattern02D1,   sp.SDB_ENEMY1 enp.ENP_LEFT_HIT  }
    ENPS {200,        024,          movePattern02D1,   sp.SDB_ENEMY1 enp.ENP_RIGHT_HIT }
...
singleEnemiesL4
    ...
    ENPS {010,        015,          movePattern02D2,   sp.SDB_ENEMY1 enp.ENP_RIGHT_ALONG    }
    ENPS {020,        015,          movePattern13D1,   sp.SDB_ENEMY3 enp.ENP_LEFT_BOUNCE    }
    ENPS {010,        015,          movePattern13D3,   sp.SDB_ENEMY2 enp.ENP_RIGHT_BOUNCE   }
    ENPS {010,        020,          movePattern18,     sp.SDB_ENEMY1 enp.ENP_LEFT_ALONG     }
    ENPS {010,        015,          movePattern18,     sp.SDB_ENEMY1 enp.ENP_RIGHT_ALONG    }

    ENPS {168,        013,          movePattern22,     sp.SDB_ENEMY1 enp.ENP_LEFT_ALONG_RP  }
    ENPS {128,        015,          movePattern22,     sp.SDB_ENEMY1 enp.ENP_LEFT_ALONG_RP  }
    ...
    ENPS {185,        011,          movePattern01D0,   sp.SDB_ENEMY1 enp.ENP_LEFT_HIT       }
    
    ENPS {227,        014,          movePattern09  ,   sp.SDB_ENEMY3 enp.ENP_RIGHT_ALONG    }
    ENPS {227,        020,          movePattern09  ,   sp.SDB_ENEMY3 enp.ENP_LEFT_HIT       }
...
singleEnemiesL6
    ...
    ENPS {016,        020,          movePattern01D1,  sp.SDB_ENEMY1 enp.ENP_RIGHT_HIT       }
    ENPS {110,        015,          movePattern01D0,  sp.SDB_ENEMY1 enp.ENP_RIGHT_HIT       }
    ENPS {160,        010,          movePattern01D1,  sp.SDB_ENEMY1 enp.ENP_LEFT_HIT        }
    ENPS {220,        030,          movePattern01D0,  sp.SDB_ENEMY1 enp.ENP_LEFT_HIT        }
    ENPS {220,        025,          movePattern01D1,  sp.SDB_ENEMY1 enp.ENP_RIGHT_HIT       }
...
singleEnemiesL7
    ;     RESPAWN_Y   RESPAWN_DELAY MOVE_PAT_ADDR      SDB_INIT      SETUP
    ENPS {10,         015,          movePattern08,   sp.SDB_ENEMY1 enp.ENP_LEFT_BOUNCE_AN  }
    ENPS {10,         020,          movePattern08,   sp.SDB_ENEMY1 enp.ENP_RIGHT_BOUNCE_AN }
    ...
    ENPS {150,        018,          movePattern08,   sp.SDB_ENEMY1 enp.ENP_LEFT_BOUNCE_AN  }
    ...
    ENPS {220,        015,          movePattern08,   sp.SDB_ENEMY1 enp.ENP_RIGHT_BOUNCE_AN }
    ...
    ENPS {110,        025,          movePattern01D1, sp.SDB_ENEMY1 enp.ENP_RIGHT_HIT       }
    ...
    ENPS {220,        023,          movePattern08,   sp.SDB_ENEMY1 enp.ENP_RIGHT_BOUNCE_AN }
