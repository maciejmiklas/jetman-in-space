...
singleEnemiesL4
    ...
    ENPS {010,        010,          movePattern18,     sp.SDB_ENEMY1 enp.ENP_RIGHT_ALONG    }

    ENPS {168,        010,          movePattern22,     sp.SDB_ENEMY1 enp.ENP_LEFT_ALONG_RP  }
    ...
    ENPS {227,        010,          movePattern09  ,   sp.SDB_ENEMY3 enp.ENP_RIGHT_ALONG    }
