...
movePattern22
    DB 19*2 + 2 + 19*2
    ; Phase 1
    DB %0'111'1'111,$F1, %0'010'1'110,$F1, %1'111'1'101,$22, %1'111'1'100,$21, %1'111'1'101,$21, %1'111'1'110,$21, %1'111'1'111,$21 
    DB %1'010'1'110,$21, %0'100'1'111,$21, %0'001'1'100,$21, %1'100'1'111,$21, %0'111'1'101,$21, %0'111'1'011,$21, %0'111'1'100,$21 
    DB %0'111'1'101,$21, %0'110'1'111,$21, %0'001'1'111,$21, %0'000'1'111,$F1, %0'000'0'111,$F1 
    ; Phase 2
    DB %0'000'1'111,$04 
    ; Phase 3
...
singleEnemiesL4
    ;     RESPAWN_Y   RESPAWN_DELAY MOVE_PAT_ADDR      SDB_INIT      SETUP
    ENPS {168,        005,          movePattern22,   sp.SDB_ENEMY1 enp.ENP_LEFT_ALONG_RP  }
