...
;       LNUM  STARS_PAL STARS_D1               STARS_D2               PLAT_SIZE              PLAT_DATA         ROC_X             ROC_DATA         ROC_ST_PAL                 SE_NUM                  SE_DEL             SE_DATA               FE_SIZE             FE_DATA        FORM_SIZE                 FORM_DEL FORM_DATA              TIA_SIZE                  TIA_DATA                    TIP_SIZE             TIP_DATA             PIC_SIZE             PIC_DATA
    ...
    LL {"08", 3,        db1.starsData1MaxYL8,  db1.starsData2MaxYL8,  db2.PLATFORM_SIZE_L8,  db2.platformsL8,  rod.ROCKET_X_L8,  rod.rocketElL8,  db1.tilePaletteStars8Bin,  0,                      0,                 0,                    fed.FENEMY_SIZE_L8, fed.fEnemyL08, 0,                        0,       0,                     tad.TILEMAP_ANIM_ROWS_L8, tad.tilemapAnimationRowsL8, db1.TILE_PAL_SIZE_L3, db1.tilePalette3Bin, db2.PICKUPS_L6_SIZE, db2.pickupsL6}
