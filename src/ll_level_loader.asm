...
;       LNUM  STARS_PAL STARS_D1               STARS_D2               STARS_FULL, PLAT_SIZE              PLAT_DATA         ROC_X             ROC_DATA         ROC_ST_PAL                 SE_NUM                  SE_DEL             SE_DATA               FE_SIZE              FE_DATA        FORM_SIZE FORM_DEL FORM_DATA              TIA_SIZE                   TIA_DATA                 TIP_SIZE             TIP_DATA             PIC_SIZE             PIC_DATA        AD_DEP_DATA    AS_MOV_DATA
    ...
    LL {"10", 1,        db1.starsData1MaxYL10, db1.starsData2MaxYL10, 1,          db2.PLATFORM_SIZE_L10, db2.platformsL10, rod.ROCKET_X_L10, rod.rocketElL10, db1.tilePaletteStars10Bin, 0,                      0,                 0,                    fed.FENEMY_SIZE_L10, fed.fEnemyL10, 0,        0,       ena.enemyFormationL10, tad.TILEMAP_ANIM_ROWS_L10, tad.tilemapAnimationL10, db1.TILE_PAL_SIZE_5, db1.tilePalette5Bin, db2.PICKUPS_L6_SIZE, db2.pickupsL6, rotd.asDeploy1, rotd.randMov1}
