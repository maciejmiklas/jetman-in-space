...
;       LNUM  STARS_PAL STARS_D1               STARS_D2               STARS_FULL, PLAT_SIZE              PLAT_DATA         ROC_X             ROC_DATA         ROC_ST_PAL                 SE_NUM                  SE_DEL             SE_DATA               FE_SIZE             FE_DATA        FORM_SIZE                 FORM_DEL FORM_DATA              TIA_SIZE                  TIA_DATA                    TIP_SIZE             TIP_DATA             PIC_SIZE             PIC_DATA        AD_DEP_DATA    AS_MOV_DATA
    ...
    LL {"09", 0,        db1.starsData1MaxYL9,  db1.starsData2MaxYL9,  0,          db2.PLATFORM_SIZE_L9,  db2.platformsL9,  rod.ROCKET_X_L9,  rod.rocketElL9,  db1.tilePaletteStars9Bin,  ena.SINGLE_ENEMIES_L9,  ens.NEXT_RESP_DEL, 0,                    0,                  fed.fEnemyL08, ena.ENEMY_FORMATION_SIZE, 0,       ena.enemyFormationL9,  tad.TILEMAP_ANIM_ROWS_L9  tad.tilemapAnimationRowsL9, db1.TILE_PAL_SIZE_4, db1.tilePalette4Bin, db2.PICKUPS_L6_SIZE, db2.pickupsL6, rotd.asDeploy3, rotd.randMov3}
