...
STARS_MODE              DB                      ; See #st.starsMode
...
levels
;       LNUM  STARS_PAL STARS_D1               STARS_D2               STARS_FULL, PLAT_SIZE              PLAT_DATA         ROC_X             ROC_DATA         ROC_ST_PAL                 SE_NUM                  SE_DEL             SE_DATA               FE_SIZE              FE_DATA        FORM_SIZE FORM_DEL FORM_DATA              TIA_SIZE                   TIA_DATA                 TIP_SIZE             TIP_DATA             PIC_SIZE             PIC_DATA        AD_DEP_DATA    AS_MOV_DATA
    LL {"01", 0,        db1.starsData1MaxYL1,  db1.starsData2MaxYL1,  1,          db2.PLATFORM_SIZE_L1,  db2.platformsL1,  rod.ROCKET_X_L1,  rod.rocketElL1,  db1.tilePaletteStars1Bin,  ena.SINGLE_ENEMIES_L1,  ens.NEXT_RESP_DEL, ena.singleEnemiesL1,  0,                   0,             0,        0,       0,                     tad.TILEMAP_ANIM_ROWS_L1,  tad.tilemapAnimationL1,  db1.TILE_PAL_SIZE_1, db1.tilePalette1Bin, db2.PICKUPS_L1_SIZE, db2.pickupsL1, rotd.asDeploy1, rotd.randMov1}
    LL {"02", 1,        db1.starsData1MaxYL2,  db1.starsData2MaxYL2,  1,          db2.PLATFORM_SIZE_L2,  db2.platformsL2,  rod.ROCKET_X_L2,  rod.rocketElL2,  db1.tilePaletteStars2Bin,  ena.SINGLE_ENEMIES_L2,  ens.NEXT_RESP_DEL, ena.singleEnemiesL2,  0,                   0,             0,        0,       0,                     tad.TILEMAP_ANIM_ROWS_L2,  tad.tilemapAnimationL2,  db1.TILE_PAL_SIZE_1, db1.tilePalette1Bin, db2.PICKUPS_L2_SIZE, db2.pickupsL2, rotd.asDeploy2, rotd.randMov2}
    LL {"03", 2,        db1.starsData1MaxYL3,  db1.starsData2MaxYL3,  1,          db2.PLATFORM_SIZE_L3,  db2.platformsL3,  rod.ROCKET_X_L3,  rod.rocketElL3,  db1.tilePaletteStars3Bin,  ena.SINGLE_ENEMIES_L3,  ens.NEXT_RESP_DEL, ena.singleEnemiesL3,  0,                   0,             7,        100,     ena.enemyFormationL3,  tad.TILEMAP_ANIM_ROWS_L3,  tad.tilemapAnimationL3,  db1.TILE_PAL_SIZE_1, db1.tilePalette1Bin, db2.PICKUPS_L3_SIZE, db2.pickupsL3, rotd.asDeploy3, rotd.randMov2}
    LL {"04", 3,        db1.starsData1MaxYL4,  db1.starsData2MaxYL4,  1,          db2.PLATFORM_SIZE_L4,  db2.platformsL4,  rod.ROCKET_X_L4,  rod.rocketElL4,  db1.tilePaletteStars4Bin,  ena.SINGLE_ENEMIES_L4,  ens.NEXT_RESP_DEL, ena.singleEnemiesL4,  0,                   0,             7,        80,      ena.enemyFormationL4,  tad.TILEMAP_ANIM_ROWS_L4,  tad.tilemapAnimationL4,  db1.TILE_PAL_SIZE_1, db1.tilePalette1Bin, db2.PICKUPS_L4_SIZE, db2.pickupsL4, rotd.asDeploy4, rotd.randMov1}
    LL {"05", 0,        db1.starsData1MaxYL5,  db1.starsData2MaxYL5,  1,          db2.PLATFORM_SIZE_L5,  db2.platformsL5,  rod.ROCKET_X_L5,  rod.rocketElL5,  db1.tilePaletteStars5Bin,  ena.SINGLE_ENEMIES_L5,  ens.NEXT_RESP_DEL, ena.singleEnemiesL5,  fed.FENEMY_SIZE_L5,  fed.fEnemyL05, 7,        70,      ena.enemyFormationL5,  tad.TILEMAP_ANIM_ROWS_L5,  tad.tilemapAnimationL5,  db1.TILE_PAL_SIZE_2, db1.tilePalette2Bin, db2.PICKUPS_L5_SIZE, db2.pickupsL5, rotd.asDeploy1, rotd.randMov1}
    LL {"06", 1,        db1.starsData1MaxYL6,  db1.starsData2MaxYL6,  1,          db2.PLATFORM_SIZE_L6,  db2.platformsL6,  rod.ROCKET_X_L6,  rod.rocketElL6,  db1.tilePaletteStars6Bin,  ena.SINGLE_ENEMIES_L6,  ens.NEXT_RESP_DEL, ena.singleEnemiesL6,  fed.FENEMY_SIZE_L6,  fed.fEnemyL06, 7,        100,     ena.enemyFormationL6,  tad.TILEMAP_ANIM_ROWS_L6,  tad.tilemapAnimationL6,  db1.TILE_PAL_SIZE_2, db1.tilePalette2Bin, db2.PICKUPS_L6_SIZE, db2.pickupsL6, rotd.asDeploy2, rotd.randMov2}
    LL {"07", 2,        db1.starsData1MaxYL7,  db1.starsData2MaxYL7,  1,          db2.PLATFORM_SIZE_L7,  db2.platformsL7,  rod.ROCKET_X_L7,  rod.rocketElL7,  db1.tilePaletteStars7Bin,  ena.SINGLE_ENEMIES_L7,  ens.NEXT_RESP_DEL, ena.singleEnemiesL7,  fed.FENEMY_SIZE_L7,  fed.fEnemyL07, 7,        100,     ena.enemyFormationL7,  tad.TILEMAP_ANIM_ROWS_L7   tad.tilemapAnimationL7,  db1.TILE_PAL_SIZE_6, db1.tilePalette6Bin, db2.PICKUPS_L6_SIZE, db2.pickupsL6, rotd.asDeploy3, rotd.randMov2}
    LL {"08", 3,        db1.starsData1MaxYL8,  db1.starsData2MaxYL8,  1,          db2.PLATFORM_SIZE_L8,  db2.platformsL8,  rod.ROCKET_X_L8,  rod.rocketElL8,  db1.tilePaletteStars8Bin,  ena.SINGLE_ENEMIES_L8   ens.NEXT_RESP_DEL, ena.singleEnemiesL8,  fed.FENEMY_SIZE_L8,  fed.fEnemyL08, 0,        0,       0,                     tad.TILEMAP_ANIM_ROWS_L8,  tad.tilemapAnimationL8,  db1.TILE_PAL_SIZE_3, db1.tilePalette3Bin, db2.PICKUPS_L6_SIZE, db2.pickupsL6, rotd.asDeploy4, rotd.randMov1}
    LL {"09", 0,        db1.starsData1MaxYL9,  db1.starsData2MaxYL9,  0,          db2.PLATFORM_SIZE_L9,  db2.platformsL9,  rod.ROCKET_X_L9,  rod.rocketElL9,  db1.tilePaletteStars9Bin,  ena.SINGLE_ENEMIES_L9,  ens.NEXT_RESP_DEL, ena.singleEnemiesL9,  fed.FENEMY_SIZE_L9,  fed.fEnemyL09, 0,        0,       0,                     tad.TILEMAP_ANIM_ROWS_L9,  tad.tilemapAnimationL9,  db1.TILE_PAL_SIZE_4, db1.tilePalette4Bin, db2.PICKUPS_L6_SIZE, db2.pickupsL6, rotd.asDeploy3, rotd.randMov2}
    LL {"10", 1,        db1.starsData1MaxYL10, db1.starsData2MaxYL10, 1,          db2.PLATFORM_SIZE_L10, db2.platformsL10, rod.ROCKET_X_L10, rod.rocketElL10, db1.tilePaletteStars10Bin, ena.SINGLE_ENEMIES_L10, ens.NEXT_RESP_DEL, ena.singleEnemiesL10, fed.FENEMY_SIZE_L10, fed.fEnemyL10, 0,        0,       0,                     tad.TILEMAP_ANIM_ROWS_L10, tad.tilemapAnimationL10, db1.TILE_PAL_SIZE_5, db1.tilePalette5Bin, db2.PICKUPS_L6_SIZE, db2.pickupsL6, rotd.asDeploy1, rotd.randMov1}
