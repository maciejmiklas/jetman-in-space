...
;       LNUM  STARS_PAL STARS_D1               STARS_D2               STARS_FULL, PLAT_SIZE              PLAT_DATA         ROC_X             ROC_DATA         ROC_ST_PAL                 SE_NUM                  SE_DEL             SE_DATA               FE_SIZE              FE_DATA        FORM_SIZE FORM_DEL FORM_DATA              TIA_SIZE                   TIA_DATA                 TIP_SIZE             TIP_DATA             PIC_SIZE             PIC_DATA        AD_DEP_DATA    AS_MOV_DATA
    ...
    LL {"03", 2,        db1.starsData1MaxYL3,  db1.starsData2MaxYL3,  1,          db2.PLATFORM_SIZE_L3,  db2.platformsL3,  rod.ROCKET_X_L3,  rod.rocketElL3,  db1.tilePaletteStars3Bin,  ena.SINGLE_ENEMIES_L3,  ens.NEXT_RESP_DEL, ena.singleEnemiesL3,  0,                   0,             10,       150,     ena.enemyFormationL3,  tad.TILEMAP_ANIM_ROWS_L3,  tad.tilemapAnimationL3,  db1.TILE_PAL_SIZE_1, db1.tilePalette1Bin, db2.PICKUPS_L3_SIZE, db2.pickupsL3, rotd.asDeploy3, rotd.randMov3}
    LL {"04", 3,        db1.starsData1MaxYL4,  db1.starsData2MaxYL4,  1,          db2.PLATFORM_SIZE_L4,  db2.platformsL4,  rod.ROCKET_X_L4,  rod.rocketElL4,  db1.tilePaletteStars4Bin,  ena.SINGLE_ENEMIES_L4,  ens.NEXT_RESP_DEL, ena.singleEnemiesL4,  0,                   0,             10,       100,     ena.enemyFormationL4,  0,                         0,                       db1.TILE_PAL_SIZE_1, db1.tilePalette1Bin, db2.PICKUPS_L4_SIZE, db2.pickupsL4, rotd.asDeploy4, rotd.randMov4}
