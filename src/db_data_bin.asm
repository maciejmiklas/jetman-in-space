...
movePattern17
;         horizontal        34deg down        horizontal        34deg up
	DB 8, %0'000'1'111,$1F, %1'011'1'111,$05, %0'000'1'111,$1B, %0'011'1'111,$05

movePattern18
;         horizontal        45deg down
	DB 4, %0'000'1'111,$0C, %1'111'1'111,$19 	
...
singleEnemiesL1
	enp.ENPS {040/*RESPAWN_Y*/, 025/*RESPAWN_DELAY*/, movePattern01D3/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_HIT  /*SETUP*/}
	enp.ENPS {040/*RESPAWN_Y*/, 025/*RESPAWN_DELAY*/, movePattern01D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_RIGHT_HIT /*SETUP*/}
	...
	enp.ENPS {085/*RESPAWN_Y*/, 045/*RESPAWN_DELAY*/, movePattern01D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_HIT  /*SETUP*/}
	...
	enp.ENPS {105/*RESPAWN_Y*/, 020/*RESPAWN_DELAY*/, movePattern01D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_HIT  /*SETUP*/}
	...
	enp.ENPS {220/*RESPAWN_Y*/, 025/*RESPAWN_DELAY*/, movePattern01D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_HIT  /*SETUP*/}
...
singleEnemiesL2
	...
	enp.ENPS {040/*RESPAWN_Y*/, 015/*RESPAWN_DELAY*/, movePattern01D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_RIGHT_HIT  /*SETUP*/}
	enp.ENPS {080/*RESPAWN_Y*/, 015/*RESPAWN_DELAY*/, movePattern02D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_HIT   /*SETUP*/}
	enp.ENPS {100/*RESPAWN_Y*/, 010/*RESPAWN_DELAY*/, movePattern02D2/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_ALONG /*SETUP*/}
	enp.ENPS {120/*RESPAWN_Y*/, 005/*RESPAWN_DELAY*/, movePattern02D1/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_RIGHT_ALONG/*SETUP*/}
	...
	enp.ENPS {180/*RESPAWN_Y*/, 022/*RESPAWN_DELAY*/, movePattern01D2/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_RIGHT_ALONG/*SETUP*/}
	...
	enp.ENPS {220/*RESPAWN_Y*/, 022/*RESPAWN_DELAY*/, movePattern01D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_ALONG /*SETUP*/}
...
singleEnemiesL3
	enp.ENPS {020/*RESPAWN_Y*/, 015/*RESPAWN_DELAY*/, movePattern01D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_HIT /*SETUP*/}
	enp.ENPS {020/*RESPAWN_Y*/, 015/*RESPAWN_DELAY*/, movePattern01D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_RIGHT_HIT/*SETUP*/}
	enp.ENPS {040/*RESPAWN_Y*/, 005/*RESPAWN_DELAY*/, movePattern02D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_HIT /*SETUP*/}
	enp.ENPS {040/*RESPAWN_Y*/, 005/*RESPAWN_DELAY*/, movePattern02D2/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_RIGHT_HIT/*SETUP*/}
	enp.ENPS {060/*RESPAWN_Y*/, 015/*RESPAWN_DELAY*/, movePattern02D1/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_HIT /*SETUP*/}
	enp.ENPS {060/*RESPAWN_Y*/, 015/*RESPAWN_DELAY*/, movePattern02D2/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_RIGHT_HIT/*SETUP*/}
	enp.ENPS {080/*RESPAWN_Y*/, 021/*RESPAWN_DELAY*/, movePattern02D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY2/*SDB_INIT*/, enp.ENP_S_LEFT_HIT /*SETUP*/}
	enp.ENPS {080/*RESPAWN_Y*/, 021/*RESPAWN_DELAY*/, movePattern02D1/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY2/*SDB_INIT*/, enp.ENP_S_RIGHT_HIT/*SETUP*/}
	enp.ENPS {100/*RESPAWN_Y*/, 018/*RESPAWN_DELAY*/, movePattern02D1/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY2/*SDB_INIT*/, enp.ENP_S_LEFT_HIT /*SETUP*/}
	enp.ENPS {100/*RESPAWN_Y*/, 018/*RESPAWN_DELAY*/, movePattern02D2/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY2/*SDB_INIT*/, enp.ENP_S_RIGHT_HIT/*SETUP*/}
	enp.ENPS {120/*RESPAWN_Y*/, 017/*RESPAWN_DELAY*/, movePattern02D1/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY2/*SDB_INIT*/, enp.ENP_S_LEFT_HIT /*SETUP*/}
	enp.ENPS {120/*RESPAWN_Y*/, 017/*RESPAWN_DELAY*/, movePattern02D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY2/*SDB_INIT*/, enp.ENP_S_RIGHT_HIT/*SETUP*/}
	enp.ENPS {140/*RESPAWN_Y*/, 013/*RESPAWN_DELAY*/, movePattern02D1/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY2/*SDB_INIT*/, enp.ENP_S_LEFT_HIT /*SETUP*/}
	enp.ENPS {140/*RESPAWN_Y*/, 013/*RESPAWN_DELAY*/, movePattern02D1/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY2/*SDB_INIT*/, enp.ENP_S_RIGHT_HIT/*SETUP*/}
	enp.ENPS {160/*RESPAWN_Y*/, 017/*RESPAWN_DELAY*/, movePattern02D1/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_HIT /*SETUP*/}
	enp.ENPS {160/*RESPAWN_Y*/, 017/*RESPAWN_DELAY*/, movePattern02D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_RIGHT_HIT/*SETUP*/}
	enp.ENPS {180/*RESPAWN_Y*/, 025/*RESPAWN_DELAY*/, movePattern02D1/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_HIT /*SETUP*/}
	...
	enp.ENPS {200/*RESPAWN_Y*/, 014/*RESPAWN_DELAY*/, movePattern02D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_HIT /*SETUP*/}
	enp.ENPS {200/*RESPAWN_Y*/, 014/*RESPAWN_DELAY*/, movePattern02D1/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_RIGHT_HIT/*SETUP*/}
...
singleEnemiesL4
	enp.ENPS {120/*RESPAWN_Y*/, 015/*RESPAWN_DELAY*/, movePattern01D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_HIT	/*SETUP*/}
	enp.ENPS {120/*RESPAWN_Y*/, 022/*RESPAWN_DELAY*/, movePattern01D2/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_RIGHT_HIT	/*SETUP*/}
	enp.ENPS {152/*RESPAWN_Y*/, 034/*RESPAWN_DELAY*/, movePattern01D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_HIT	/*SETUP*/}
	enp.ENPS {154/*RESPAWN_Y*/, 021/*RESPAWN_DELAY*/, movePattern01D2/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_RIGHT_HIT	/*SETUP*/}
	enp.ENPS {184/*RESPAWN_Y*/, 011/*RESPAWN_DELAY*/, movePattern01D3/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_HIT	/*SETUP*/}
	enp.ENPS {184/*RESPAWN_Y*/, 008/*RESPAWN_DELAY*/, movePattern01D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_RIGHT_HIT	/*SETUP*/}
	enp.ENPS {050/*RESPAWN_Y*/, 022/*RESPAWN_DELAY*/, movePattern06  /*MOVE_PAT_POINTER*/, sr.SDB_ENEMY2/*SDB_INIT*/, enp.ENP_S_LEFT_ALONG	/*SETUP*/}
	enp.ENPS {220/*RESPAWN_Y*/, 010/*RESPAWN_DELAY*/, movePattern01D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY3/*SDB_INIT*/, enp.ENP_S_LEFT_HIT	/*SETUP*/}
	enp.ENPS {220/*RESPAWN_Y*/, 020/*RESPAWN_DELAY*/, movePattern01D2/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY3/*SDB_INIT*/, enp.ENP_S_RIGHT_HIT	/*SETUP*/}
	enp.ENPS {010/*RESPAWN_Y*/, 025/*RESPAWN_DELAY*/, movePattern02D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_HIT	/*SETUP*/}
	enp.ENPS {010/*RESPAWN_Y*/, 035/*RESPAWN_DELAY*/, movePattern02D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_RIGHT_HIT	/*SETUP*/}
	enp.ENPS {010/*RESPAWN_Y*/, 025/*RESPAWN_DELAY*/, movePattern13D1/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY3/*SDB_INIT*/, enp.ENP_S_LEFT_ALONG	/*SETUP*/}
	enp.ENPS {010/*RESPAWN_Y*/, 030/*RESPAWN_DELAY*/, movePattern13D1/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY2/*SDB_INIT*/, enp.ENP_S_RIGHT_ALONG	/*SETUP*/}
	enp.ENPS {005/*RESPAWN_Y*/, 022/*RESPAWN_DELAY*/, movePattern13D1/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_ALONG	/*SETUP*/}
	enp.ENPS {005/*RESPAWN_Y*/, 022/*RESPAWN_DELAY*/, movePattern13D1/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_RIGHT_ALONG	/*SETUP*/}
	enp.ENPS {010/*RESPAWN_Y*/, 025/*RESPAWN_DELAY*/, movePattern18  /*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_HIT	/*SETUP*/}
	enp.ENPS {010/*RESPAWN_Y*/, 025/*RESPAWN_DELAY*/, movePattern18  /*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_HIT	/*SETUP*/}
	enp.ENPS {060/*RESPAWN_Y*/, 015/*RESPAWN_DELAY*/, movePattern01D0/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_LEFT_HIT	/*SETUP*/}
	enp.ENPS {060/*RESPAWN_Y*/, 015/*RESPAWN_DELAY*/, movePattern01D2/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY1/*SDB_INIT*/, enp.ENP_S_RIGHT_HIT	/*SETUP*/}
	enp.ENPS {020/*RESPAWN_Y*/, 005/*RESPAWN_DELAY*/, movePattern09  /*MOVE_PAT_POINTER*/, sr.SDB_ENEMY2/*SDB_INIT*/, enp.ENP_S_RIGHT_HIT	/*SETUP*/}	
SINGLE_ENEMIES_L4 		= 20
enemyFormationL4 enp.ENPS {085/*RESPAWN_Y*/, 3/*RESPAWN_DELAY*/, movePattern17/*MOVE_PAT_POINTER*/, sr.SDB_ENEMY2/*SDB_INIT*/, enp.ENP_S_LEFT_ALONG/*SETUP*/}
...
platformsL4
	...
	pl.PLA {14*8/*X_LEFT*/, 14*8/*X_RIGHT*/, 25*8/*Y_TOP*/, 25*8/*Y_BOTTOM*/}

	pl.PLA {23*8/*X_LEFT*/, 23*8/*X_RIGHT*/, 17*8/*Y_TOP*/, 18*8/*Y_BOTTOM*/}
	pl.PLA {23*8/*X_LEFT*/, 23*8/*X_RIGHT*/, 21*8/*Y_TOP*/, 22*8/*Y_BOTTOM*/}
	pl.PLA {23*8/*X_LEFT*/, 23*8/*X_RIGHT*/, 25*8/*Y_TOP*/, 25]*8/*Y_BOTTOM*/}
