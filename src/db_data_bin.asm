...
;----------------------------------------------------------;
;          #Load Game Background (Bank 18...23)            ;
;----------------------------------------------------------;
...
;----------------------------------------------------------;
	...
	MMU _RAM_SLOT6, STARTS_B44					; Assign slots 6 to banks 43
	ORG _RAM_SLOT6_START_HC000					; Set memmory pointer to start of the slot 6
...
starsBinLength = $ - starsBin
	...
	ASSERT $ > _RAM_SLOT6_START_HC000			; All data should fit into slot 6,7 
	ASSERT $ <= _RAM_SLOT6_END_HDFFF 			
	ASSERT $$ == STARTS_B44 					; All data should fit into bank 43
;----------------------------------------------------------;
;                       ENDMODULE                          ;
;----------------------------------------------------------;
	ENDMODULE