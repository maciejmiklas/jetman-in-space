...
;----------------------------------------------------------;
    ...
    INCLUDE "jt_fred_state.asm"
    INCLUDE "jpo_fred_position.asm"
    INCLUDE "jco_fred_collision.asm"
    INCLUDE "js_fred_sprite.asm"
    INCLUDE "pl_platform.asm"
    INCLUDE "bg_background.asm"
    INCLUDE "jm_fred_move.asm"
    INCLUDE "jw_fred_weapon.asm"
...
; https://z00m128.github.io/sjasmplus/documentation.html
    ...
    CSPECTMAP "FredInSpace.map"                      ; Generate a map file for use with Cspect.

    ; This sets the name of the project, the start address, and the initial stack pointer.
    SAVENEX OPEN "FredInSpace.nex", start, _RAM_SLOT4_STA_H8000
