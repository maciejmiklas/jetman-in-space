...
mono cspect.exe -fullscreen -brk -tv -zxnext -nextrom -mmc=/Users/mmiklas/Development/ZX_Spectrum/opt/cspect-next/cspect-next-2gb.img -map="/Users/mmiklas/Development/ZX_Spectrum/prj/jetman-in-space/bin/jetman.map"